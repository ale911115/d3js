(function () {
  ...
  angular
    .module('app')
    .controller('D3JSMultiSeriesLineChartController', D3JSMultiSeriesLineChartController);

  D3JSMultiSeriesLineChartController.inject;
 

  function D3JSMultiSeriesLineChartController() {
    var h = 600;
    var h2 = 500;
    var w = 1280;
    ...
    var svg = d3.select("#multi-series-line-chart").append("svg")
    ...
    d3.tsv("app/d3js/multi-series-line-chart/data.tsv", function(error, data) { 
